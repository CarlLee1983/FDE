...
- [New-evidence reconciliation](2026-09-09-new-evidence-reconciliation.md) — baseline and post-change runs on information arriving after a conclusion, scope-separated coexistence, and an ordinary analysis control case. Round 2 re-adjudicates case B for scope over-reach, tests fact verification against a knowing role, verifies an in-place partial update of a case document by file diff, and adds an independent adjudicator over all its answers.
