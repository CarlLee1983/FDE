...
Installer 只會寫入 `.agents/skills/fde-project-work/` 與／或 `.claude/skills/fde-project-work/`。若 Skill 已存在，指令會拒絕覆寫本地變更。安裝、第一次使用、更新與移除流程見[五分鐘 Quick Start](docs/zh-TW/quickstart.md)。
